...
public class NormalUserWindow extends JFrame {
	...
	public NormalUserWindow() {
		...
		userLookupAction userLookup = new userLookupAction(scrollPane_1, lookupFirstField, lookupUserLastField, lookupEmailField, lookupUsernameField, SQLConnect);
		...
		formatDeptTable();
		scrollPane_2.setViewportView(departmentOverviewTable);
